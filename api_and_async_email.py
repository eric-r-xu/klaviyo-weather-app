...
def api_and_email_task(sem, cityID, city_name, dateFact, tomorrow, recipients):
...
def main():
    ...
    target_time = datetime(current_time.year, current_time.month, current_time.day, 7, 58, 0, tzinfo=tz)
    ...
    for row in tblDimEmailCity_sorted.itertuples(index=True, name="Pandas"):
        ...
        api_and_email_task(sem, cityID, city_name, dateFact, tomorrow, recipients)
